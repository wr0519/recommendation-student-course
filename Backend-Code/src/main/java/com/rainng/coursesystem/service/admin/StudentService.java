...
public class StudentService extends BaseService {
    ...
    public ResultVO deleteLike(){
        return result(manager.deleteLike());
    }

    public ResultVO insertLike(StudentLikeEntity studentLikeEntity){
        return result(manager.insertLike(studentLikeEntity));
    }
