...
public class StudentManager extends BaseManager {
    ...
    public int deleteLike(){return studentDAO.deleteLike();}

    public int insertLike(StudentLikeEntity studentLikeEntity){
        return studentDAO.insertLike(studentLikeEntity);
    }
